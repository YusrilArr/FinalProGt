...
public class KartukeluargaRepo implements IKartukeluargaRepo {
	...
	public Kartukeluarga insertKartu(Kartukeluarga kartukeluarga) {
		...
		String query = "INSERT  INTO tb_kartu_keluarga(alamat, desa_kelurahan, kabupaten_kota, kecamatan, kode_pos, nomor_kk, provinsi, rt, rw)"
				+" VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
		jdbcTemplate.update(query, new Object[] {kartukeluarga.getAlamat(), kartukeluarga.getDesa_kelurahan(), kartukeluarga.getKabupaten_kota(),
				kartukeluarga.getKecamatan(), kartukeluarga.getKode_pos(), kartukeluarga.getNomor_kk(), kartukeluarga.getProvinsi(),
				kartukeluarga.getRt(), kartukeluarga.getRw()});
	...
	public Kartukeluarga updateKartu(int id, Kartukeluarga kartukeluarga) {
		...
		jdbcTemplate.update(query, new Object[] {kartukeluarga.getAlamat(), kartukeluarga.getDesa_kelurahan(), kartukeluarga.getKabupaten_kota(),
				kartukeluarga.getKecamatan(), kartukeluarga.getKode_pos(), kartukeluarga.getNomor_kk(), kartukeluarga.getProvinsi(),
				kartukeluarga.getRt(), kartukeluarga.getRw(), id});
		return kartukeluarga;
	}
